...
def ssrWrapper (appName : String) : String :=
  ...
  "import * as mod from './ssr_app.mjs';\n" ++
...
def buildJs (outDir : FilePath) (prod : Bool) : IO Bool := do
  ...
  | some appName =>
      ...
      if (← sh "lake" (#["env", qedjs] ++ minArgs ++ #[ssrOut, mod, "--"] ++
      ...
      IO.FS.writeFile (outDir / "ssr.mjs") (ssrWrapper appName)
  | none =>
